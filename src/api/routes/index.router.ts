...
import { buildWebhookReceiverRouter } from '@api/integrations/webhook-receiver/routes/webhook-receiver.router';
import { waMonitor, webhookReceiverController } from '@api/server.module';
...
router
  ...
  .use('/webhook', buildWebhookReceiverRouter(webhookReceiverController));
